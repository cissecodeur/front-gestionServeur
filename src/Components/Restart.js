...
export default class Restart extends Component {
        ...
        handleUpdate = e => {
            ...
            axios.post("http://localhost:9090/server/redemarrerOne/",server)
            .then(response => {
                if(response.data != null){
    ...
    render() {
        ...
        const  title ="Voulez vous redemarrer le serveur ?";
        ...
        return (                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
               ...
               <div>
                  <div style = {{ "display" : this.state.show ? "block" : "none"}}>
                      <MyToastGreen
                          show = { this.state.show }  message = {"Serveur redemarré avec succes" }
                          type ={ "succes" }/>
                  </div>
